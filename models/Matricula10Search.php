...
/**
 * Matricula10Search represents the model behind the search form of `app\models\TblMatriculaEstudiantil10grado`.
 */
class Matricula10Search extends TblMatriculaEstudiantil10grado
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = TblMatriculaEstudiantil10grado::find();
