...
/**
 * This is the model class for table "tbl_matricula_estudiantil_10grado".
 *
 * @property int $id
 * @property string $ci
 ...
 * @property int $activo
 */
class TblMatriculaEstudiantil10grado extends \yii\db\ActiveRecord
{
    ...
    {
        return 'tbl_matricula_estudiantil_10grado';
    }
