...
/**
 * Matricula12Search represents the model behind the search form of `app\models\TblMatriculaEstudiantil12grado`.
 */
class Matricula12Search extends TblMatriculaEstudiantil12grado
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = TblMatriculaEstudiantil12grado::find();
