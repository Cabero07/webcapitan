...
/**
 * This is the model class for table "tbl_matricula_estudiantil_11grado".
 *
 * @property int $id
 * @property string $ci
 ...
 * @property int $activo
 */
class TblMatriculaEstudiantil11grado extends \yii\db\ActiveRecord
{
    ...
    {
        return 'tbl_matricula_estudiantil_11grado';
    }
