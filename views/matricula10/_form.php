...
<div class="card shadow">
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0">
            ...
            <?= $model->isNewRecord ? 'Registrar Estudiante 10mo Grado' : 'Editar Matrícula Estudiante 10mo Grado' ?>
        </h5>
    </div>
    <div class="card-body">
        ...
        <fieldset class="mb-4">
            ...
            <div class="row">
                ...
                <div class="col-md-2"><?= $form->field($model, 'grado')->textInput(['maxlength'=>20,'value'=>'10'])?></div>
