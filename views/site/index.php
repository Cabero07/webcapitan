...
<body>
  <main>
    <div class="container">
    <h2> Sistema de gestion de estudiantes y profesores del Preuniversitario Capitan</h2>
      <div class="row">
        <div class="col-lg-4">
        ...
        <div class="col-lg-4">
          ...
          <h2>Seguridad</h2>
          <p>Sistema seguro ante diversos tipos de ataques para la seguridad de los datos de los estudiantes y profesores.</p>
        </div><!-- /.col-lg-4 -->
      </div><!-- /.row -->
